...
namespace FlightSystem.Migrations
{
    ...
    [Migration("20260117130855_NotificationUpgrade")]
    partial class NotificationUpgrade
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FlightSystem.Models.Flight", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AircraftId = 2,
                            AirlineId = 3,
                            ArrivalTime = new DateTime(2026, 1, 19, 15, 8, 54, 948, DateTimeKind.Local).AddTicks(440),
                            AvailableSeats = 100,
                            Code = "FS-101",
                            DepartureTime = new DateTime(2026, 1, 19, 14, 8, 54, 948, DateTimeKind.Local).AddTicks(360),
                            DestinationId = 1,
                            Price = 120m,
                            Status = 0
                        },
                        new
                        {
                            ...
                            AircraftId = 1,
                            AirlineId = 4,
                            ArrivalTime = new DateTime(2026, 1, 21, 16, 8, 54, 948, DateTimeKind.Local).AddTicks(459),
                            AvailableSeats = 140,
                            Code = "FS-202",
                            DepartureTime = new DateTime(2026, 1, 21, 14, 8, 54, 948, DateTimeKind.Local).AddTicks(457),
                            DestinationId = 2,
                            Price = 180m,
                            Status = 0
                        });
            ...
            modelBuilder.Entity("FlightSystem.Models.Reservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 1, 17, 13, 8, 54, 948, DateTimeKind.Utc).AddTicks(780),
                            FlightId = 1,
                            SeatNumber = "12A",
                            Status = 0,
                            TotalPrice = 140m,
