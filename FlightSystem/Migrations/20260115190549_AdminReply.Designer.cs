...
namespace FlightSystem.Migrations
{
    ...
    [Migration("20260115190549_AdminReply")]
    partial class AdminReply
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FlightSystem.Models.Flight", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AircraftId = 2,
                            AirlineId = 3,
                            ArrivalTime = new DateTime(2026, 1, 17, 21, 5, 48, 525, DateTimeKind.Local).AddTicks(4332),
                            AvailableSeats = 100,
                            Code = "FS-101",
                            DepartureTime = new DateTime(2026, 1, 17, 20, 5, 48, 525, DateTimeKind.Local).AddTicks(4275),
                            DestinationId = 1,
                            Price = 120m,
                            Status = 0
                        },
                        new
                        {
                            ...
                            AircraftId = 1,
                            AirlineId = 4,
                            ArrivalTime = new DateTime(2026, 1, 19, 22, 5, 48, 525, DateTimeKind.Local).AddTicks(4340),
                            AvailableSeats = 140,
                            Code = "FS-202",
                            DepartureTime = new DateTime(2026, 1, 19, 20, 5, 48, 525, DateTimeKind.Local).AddTicks(4339),
                            DestinationId = 2,
                            Price = 180m,
                            Status = 0
                        });
            ...
            modelBuilder.Entity("FlightSystem.Models.Reservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 1, 15, 19, 5, 48, 525, DateTimeKind.Utc).AddTicks(4519),
                            FlightId = 1,
                            SeatNumber = "12A",
                            Status = 0,
                            TotalPrice = 140m,
